<template>
    <div class="flex items-center justify-center min-h-screen bg-gray-100">
        <div class="w-full max-w-lg bg-white border border-gray-300 rounded-lg shadow-lg p-8">
            ...
            <form @submit.prevent="handleSignup">
                ...
                <div class="mb-4 flex space-x-4">
                    <div class="flex-1">
                        ...
                        <p v-if="formErrors.firstNameError" class="text-red-500 text-sm mt-1">{{
                            formErrors.firstNameError }}</p>
                    </div>
                    <div class="flex-1">
                ...
                <div class="mb-4 flex space-x-4">
                    <div class="flex-1">
                        ...
                        <input type="email" id="email" v-model="formData.email" @input="validateFieldError('email')"
                            ...
                            placeholder="Email" />
                        <p v-if="formErrors.emailError" class="text-red-500 text-sm text-left mt-2">{{
                            formErrors.emailError }}</p>
                    </div>
                    ...
                    <div class="flex-1">
                        ...
                        <p v-if="formErrors.roleIdError" class="text-red-500 text-sm mt-1">{{ formErrors.roleIdError }}
                        </p>
                    </div>
                </div>
...
// Get the necessary properties and functions from useSignup composable
const { formData, formErrors, loading, handleSignup, validateFieldError } = useSignup();
